...
# PDF page offset - consistent throughout the manual
# Manual page 1 = PDF page 7 (offset of 6)
# This offset applies to ALL parts
PAGE_OFFSET = 6
...
for section_file, section_title, manual_start, manual_end in toc:
    # Convert manual pages to PDF pages using consistent offset
