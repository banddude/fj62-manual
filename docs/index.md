...
![page-0-01](images/page-0-01.jpg)
...
![page-0-02](images/page-0-02.jpg)
...
![page-0-03](images/page-0-03.jpg)
...
![page-0-04](images/page-0-04.jpg)
...
![page-0-05](images/page-0-05.jpg)
...
![page-0-06](images/page-0-06.jpg)
...
CAUTION:!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
After inserting the tab, make sure that the connection is secure and the seat belt extender is not twisted.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
![diagram: master switch and control switch](10720-02)
...
![diagram: day / night lever](10730F01)
...
![Page 57](images/page-057.jpg)

---

## Page 58

# Cassette tape player (type A) —
...
![Page 92.1](images/page-092-01.jpg)
...
![Page 92.2](images/page-092-02.jpg)
...
![Page 92.3](images/page-092-03.jpg)
...
![Page 92.4](images/page-092-04.jpg)
...
2. If the connectors are O.K., the engine may be flooded because of repeated cranking. See "(b) Starting the flooded engine" for further instructions.

3. If the engine still will not start, it needs adjustment or repair. Call a Toyota dealer or qualified repair shop for assistance.
...
Diagram text:
- REMOVE ALL VENT CAPS AND LAY CLOTH OVER OPEN VENTS (NOT NECESSARY FOR EXTENDED (4) MAINTENANCE INTERVAL BATTERY)
- JUMPER CABLES
- DISCHARGED BATTERY
...
![Page 115](images/page-115.jpg)

---

## Page 116

4. Connect the jumper cables in the exact order shown in the illustration: positive-to-positive(+), and negative-to-engine or body ground(−). Note that you first connect the positive cable to the discharged battery and then to the booster battery. Next, connect the negative cable to the booster battery and then to a solid, stationary, metallic point (e.g. engine hanging hook) away from the battery. Do not connect it to or near any part that moves when the engine is cranked.
...
7. After the engine temperature has cooled to normal, again check the coolant level in the reservoir or if necessary, bring it up to half full again. Serious coolant loss indicates a leak in the system. You should have it checked as soon as possible at your Toyota dealer.

cruisercult.com

![Page 116](images/page-116.jpg)
...
It is, of course, necessary to keep your vehicle clean by regular washing, but to prevent corrosion, the following points should be observed:
...
![Page 131](images/page-131.jpg)

---

## Page 132

# INSIDE THE VEHICLE (cont.)
...
![Page 133](images/page-133.jpg)

---

## Page 134

| IN THE ENGINE COMPARTMENT (cont.) | Items listed below should be checked from time to time, e.g. each time when refueling. |
|---|---|
...
12. Brake linings and drums  
13. Brake pads and discs  
14. Brake lines and hoses  
15. Steering linkage  
16. Steering gear box  
17. Automatic transmission  
18. Transfer and differential  
19. Wheel bearing grease  
20. Steering knuckle and chassis grease  
21. Propeller shaft grease  
22. Bolts and nuts on chassis and body  
   «See note 4.»
...
Parts:
- Sealed beam headlight inner unit, Number  
  4651, 50 W
- Sealed beam headlight outer unit, Number  
  4652, 40/60 W

Tools:
- Screwdriver (for headlight ornament  
  screws and unit retainer screws)

# Replacing light bulbs

Parts:
- Bulb with same number and wattage rat-  
...
a. Park the vehicle on a level spot. Warm up the engine until the engine temperature gauge shows a rise. (Warm oil will drain faster and more thoroughly.) Turn the engine off.
b. Remove the oil filler cap. This allows air to enter the engine as the oil drains.

![60050-04 LOOSEN]

2. Remove the drain plug and allow the oil to drain fully.
a. Place a drain pan under the drain plug.
b. Using a wrench, remove the drain plug. Allow the oil to drain fully.
...
3. Remove the old oil filter and install a new one hand-tight. Reinstall the drain plug.
a. Using an oil filter wrench (any of several common types will work), loosen the oil filter. It turns counterclockwise. Once loose, you may unscrew it the rest of the way by hand. When removing it, hold up the end so that oil does not spill out.
b. With a clean rag, wipe off the mounting surface on the engine so that the new filter will seat well. Make sure that the old gasket has not stuck to the mounting surface. If it has, remove it before installing the new filter.
...
![Page 151](images/page-151.jpg)

---

## Page 152

d. Screw the new filter into place and tighten it until the gasket contacts the seat. Then give it additional 3/4 turn to seat the filter.
...
![Page 153](images/page-153.jpg)

---

## Page 154

# 2. Close the two drain plugs and fill the system with ethylene-glycol coolant and water. Install the radiator cap.
...
4. If the blinking has a short pause, there is a problem somewhere in the engine system.
...
![BRAKE FLUID RESERVOIR](60220101)
...
![Reservoir being filled](60220102)
...
1. Check the fluid level only when the transmission is hot (normal operating temperature). With the vehicle level, first set the parking brake and then start the engine. While the engine is idling, depress the brake pedal and shift the selector lever into each range from "P" to "L" and return to "P".
...
2. With the engine still idling, check the fluid level and condition on the dipstick. If necessary, add DEXRON®-II automatic transmission fluid.
...
![Page 165](images/page-165.jpg)

---

## Page 166

- The pressure should be checked only when the tires are cold. If your vehicle has been parked for at least 3 hours and has not been driven for more than 1 mile or 1.5 km since, you will get an accurate cold tire pressure reading.
...
![Battery diagram showing electrolyte level](image)
...
![REPLACEMENT HOLE](60270F01) ![PROTRUSIONS](60270F02)
...
2. Loosen the retainer screws and take out the beam unit together with the retainer, unplugging the connector.
...
3. Install the unit with the single protrusion on the glass face upward, plugging the connector. Install the retainer.
...
![Page 179](images/page-179.jpg)

---

## Page 180

# LIGHT LOCATIONS — FRONT VIEW
...
![Page 186](images/page-186.jpg)

---

## Page 187

- 8. HAZ-HORN 15 A: Emergency flashers, horns
- 9. ENGINE 10 A: Charging system, emission control system
- 10. IGN 7.5 A: Emission control system, electric underhood fan, electronic fuel injection system
- 11. TURN 7.5 A: Turn signal lights
- 12. WIPER 20 A: Windshield wipers and washer, rear window wiper and washer, back-up lights, unengaged "Park" warning light
- 13. A.C 10 A: Environmental cooling system
- 14. DEFOG 20 A: Rear window defogger

- 15. DOME 7.5 A: Interior light, luggage compartment light, inspection light socket, clock, key reminder buzzer
- 16. CHARGE 7.5 A: Charging system, discharge warning light
- 17. GAUGES 7.5 A: Gauges and meters, warning lights and buzzer (except discharge warning light), front drive control system
- 18. SPARE 7.5 A: Spare fuse
- 19. SPARE 15 A: Spare fuse

Circuit breakers
- 20. 30 A: Environmental control system
- 21. 30 A: Power windows
- 22. 14 A: Power door lock system

cruisercult.com

187

![Page 187](images/page-187.jpg)
